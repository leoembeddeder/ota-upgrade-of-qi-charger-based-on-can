...
{
  return (uint8_t)can_x->err_bit.recnt;
}
...
{
  return (uint8_t)can_x->err_bit.tecnt;
}
...
{
  return (can_error_type)can_x->err_bit.koer;
}
...
{
  return (can_stb_status_type)can_x->ctrlstat_bit.tsstat;
}
