...
#ifndef __AT32F422_426_PWC_H
#define __AT32F422_426_PWC_H
...
#define PWC_WAKEUP_PIN1_FLAG             ((uint32_t)0x00010000) /*!< wakeup pin1 event flag */
#define PWC_WAKEUP_PIN2_FLAG             ((uint32_t)0x00020000) /*!< wakeup pin2 event flag */
#define PWC_WAKEUP_PIN6_FLAG             ((uint32_t)0x00200000) /*!< wakeup pin6 event flag */
#define PWC_WAKEUP_PIN7_FLAG             ((uint32_t)0x00400000) /*!< wakeup pin7 event flag */
...
typedef struct
{
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t clsw1ef              : 1; /* [16] */
      __IO uint32_t clsw2ef              : 1; /* [17] */
      __IO uint32_t reserved2            : 3; /* [20:18] */
      __IO uint32_t clsw6ef              : 1; /* [21] */
      __IO uint32_t clsw7ef              : 1; /* [22] */
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t sw1ef                : 1; /* [16] */
      __IO uint32_t sw2ef                : 1; /* [17] */
      __IO uint32_t reserved4            : 3; /* [20:18] */
      __IO uint32_t sw6ef                : 1; /* [21] */
      __IO uint32_t sw7ef                : 1; /* [22] */
