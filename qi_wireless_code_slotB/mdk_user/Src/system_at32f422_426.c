...
/** @addtogroup AT32F422_426_system
  * @{
  */
...
/** @addtogroup AT32F422_426_system_private_variables
  * @{
  */
...
/** @addtogroup AT32F422_426_system_private_functions
  * @{
  */
...
void SystemInit (void)
{
  ...
  /* reset cfg register, include sclk switch, ahbdiv, apb1div, apb2div, adcdiv,
     clkout pllrcs, pllhextdiv, pllmult bits */
  CRM->cfg = (0x0);
