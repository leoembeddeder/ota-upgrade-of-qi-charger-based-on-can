...
#define UDS_SID_TRANSFER_EXIT        0x37U        /*!< RequestTransferExit (APP 验签+commit_backup 后自复位，BOOT 搬运 Backup→App) */
...
#define DID_QI_VERSION_QUERY        0x2013U   /*!< 读 Qi 芯片固件版本（主动问询），2B LE；应答 62 20 13 ver_lo ver_hi */
